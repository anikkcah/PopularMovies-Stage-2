...
import static com.example.popularmovies2.utils.Constants.ZERO;
...
public class FormatUtils {
    ...
    public static String formatNumber(int number) {
        DecimalFormat decimalFormat = new DecimalFormat(Constants.PATTERN_FORMAT_NUMBER);
    ...
    public static String formatCurrency(long number) {
        DecimalFormat decimalFormat = new DecimalFormat(Constants.PATTERN_FORMAT_CURRENCY);
        return decimalFormat.format(number);
    }
    ...
    public static String formatDate(String releaseDate) {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                Constants.PATTERN_FORMAT_DATE_INPUT, Locale.getDefault());
        ...
        SimpleDateFormat outputDateFormat = new SimpleDateFormat(
                Constants.PATTERN_FORMAT_DATE_OUTPUT, Locale.getDefault());
