...
import com.example.popularmovies2.databinding.MovieListItemBinding;
...
/**
 * {@link MoviePagedListAdapter} is responsible for representing movie data from
 * PagedList in a RecyclerView.
 * The PagedListAdapter is notified when pages are loaded, and it uses
 * DiffUtil to compute fine grain updates as new data is received.
 */
public class MoviePagedListAdapter extends PagedListAdapter<Movie, MoviePagedListAdapter.MoviePagedViewHolder> {


    /**
     * an on-click handler that we've defined to make it easy for an
     * Activity to interface with our RecyclerView.
     */
    ...
    /**
     * Tell MoviePagedListAdapter how to compute the differences between the
     * two elements
     */
     ...
     *
     * @param onClickHandler The onclick handler for this adapter. This single handler
     ...
     *                 you can use this viewType integer to provide a different layout.
     * @return A new MoviePagedViewHolder that holds the MovieListItemBinding
     */
    @NonNull
    @Override
    public MoviePagedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
     ...
     */
    @Override
    public void onBindViewHolder(MoviePagedViewHolder holder, int position){
    ...
    public class MoviePagedViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        /**
         * This method will take a Movie object as input and use that movie to display
         * the appropriate text and an image within a list item.
         *
        ...
        /**
         * called by thte child views during a click
         *
